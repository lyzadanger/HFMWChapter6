...
<div data-role="page">
  ...
  <div data-role="header">
    ...
    <a href="howto.html" data-rel="dialog" data-icon="info" class="ui-btn-right" data-role="button" data-theme="b">How To</a>
  </div><!-- /header -->
      ...
      <?php for ($i = 0; $i < 6; $i++): // 6 fields if non-JS ?>
        <li class="color-input" data-role="fieldcontain">
          ...
          <select name="colors[]" for="color-<?php print $i ?>">
            ...
            <option value="#3c516c">Dark Slate</option>
        ...
        <li class="size-input" data-role="fieldcontain">
          <label for="size-<?php print $i ?>">Size</label>
          <input id="size-<?php print $i ?>" type="range" min="2" max="72" autocomplete="false" name="sizes[]" value="" placeholder="Size" />
        </li>
      <?php endfor; ?>
